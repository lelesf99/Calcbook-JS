import{a as N,f as z,c as y,t as Ct,s as ce,d as Ze,e as It,b as Je}from"../chunks/Bz9pcTi_.js";import{K as dt,d as ft,aL as Pt,ap as Rt,h as De,aC as pt,aD as ye,g as $e,f as _e,i as Et,au as ht,j as be,b as et,c as At,a4 as gt,u as le,aM as vt,aN as Fe,C as m,aO as mt,a0 as Dt,aP as Ot,p as x,A as U,w as G,n as B,t as oe,o as Q,an as Nt,aQ as St,q as _,v as F,a6 as ue,x as V,a7 as de,B as Tt,aR as Lt,V as Mt,aS as bt}from"../chunks/R3T74W7k.js";import{a as Re,b as H,s as ne,r as K,p as Xt}from"../chunks/vGbNO2P5.js";import{i as te,b as Le}from"../chunks/D0UFlnsV.js";import{k as He,P as ge,l as Xe,e as me,B as q,i as Be,h as Bt,m as Ge,I as se,s as re,n as Gt,o as kt,t as ie,b as ve,p as yt,q as Y,u as ke,v as $t,w as fe,j as Ie,x as Ve,y as tt,c as _t,r as Ft,a as xe,g as Ce,z as Oe}from"../chunks/DYeB0fAY.js";function Ht(t,e){let n=null,s=De;var a;if(De){n=Et;for(var r=ht(document.head);r!==null&&(r.nodeType!==pt||r.data!==t);)r=ye(r);if(r===null)$e(!1);else{var o=ye(r);r.remove(),_e(o)}}De||(a=document.head.appendChild(dt()));try{ft(()=>e(a),Pt|Rt)}finally{s&&($e(!0),_e(n))}}function nt(t,e,n){be(()=>{var s=et(()=>e(t,n?.())||{});if(s?.destroy)return()=>s.destroy()})}function Vt(t=!1){const e=At,n=e.l.u;if(!n)return;let s=()=>mt(e.s);if(t){let a=0,r={};const o=Dt(()=>{let i=!1;const l=e.s;for(const c in l)l[c]!==r[c]&&(r[c]=l[c],i=!0);return i&&a++,a});s=()=>m(o)}n.b.length&&gt(()=>{Qe(e,s),Fe(n.b)}),le(()=>{const a=et(()=>n.m.map(vt));return()=>{for(const r of a)typeof r=="function"&&r()}}),n.a.length&&le(()=>{Qe(e,s),Fe(n.a)})}function Qe(t,e){if(t.l.s)for(const n of t.l.s)m(n);e()}const xt=!0,ss=Object.freeze(Object.defineProperty({__proto__:null,prerender:xt},Symbol.toStringTag,{value:"Module"}));Ot();const Qt=/PIC(TURE)?\s+([A-Za-z0-9()V\.]+)/i,wt=/OCCURS\s+(\d+)\s+TIMES/i,Ut=/REDEFINES\s+([A-Za-z0-9\-]+)/i;function zt(t){if(!t)return;const e=t.toUpperCase();return e==="COMP"||e==="COMP-1"||e==="COMP-2"||e==="COMPUTATIONAL"||e==="BINARY"||e==="COMP-5"?e:e==="COMP-3"||e==="COMPUTATIONAL-3"||e==="PACKED-DECIMAL"?"COMP-3":"DISPLAY"}function we(t){if(!t)return 0;if(/^9+$/.test(t))return t.length;const e=t.match(/^9\((\d+)\)$/);if(e)return parseInt(e[1],10)}function Wt(t){const n=t.split(/\r?\n/).map(r=>r.length>6?r.slice(6):r).map(r=>r.replace(/\r$/,"")).filter(r=>r.trim().length>0).filter(r=>!r.trim().startsWith("*")),s=[];let a="";for(let r=0;r<n.length;r++){const o=n[r],i=o.trimEnd(),l=i.endsWith("-"),c=!i.endsWith(".");l||c?a+=i.replace(/-$/,""):(a+=o,s.push(a.trim()),a="")}return a.trim()&&s.push(a.trim()),s}function Yt(t){let e=t.toUpperCase().replace(".",""),n=!1;if(e.startsWith("S")&&(n=!0,e=e.slice(1)),e.startsWith("X")){const s=e.match(/X\((\d+)\)/),a=s?parseInt(s[1],10):(e.match(/X/g)||[]).length;return{raw:t,type:"ALPHA",length:a,signed:!1}}if(e.startsWith("9")){const s=e.match(/^(9+|9\(\d+\))(?:V(9+|9\(\d+\)))?$/);if(s){const i=we(s[1]),l=we(s[2]);return{raw:t,type:"NUMERIC",length:i+l,decimals:l||void 0,signed:n}}const a=e.split("V"),r=(a[0].match(/9/g)||[]).length,o=a[1]?(a[1].match(/9/g)||[]).length:0;return{raw:t,type:"NUMERIC",length:r+o,decimals:o||void 0,signed:n}}}function jt(t){const e=Wt(t),n=[],s=[];let a=1;for(const r of e){const o=r.trim().split(/\s+/),i=parseInt(o[0],10),l=o[1];if(Number.isNaN(i)||!l)continue;let c=l.replace(/\.$/,"");const R={level:i,name:c,isFiller:c.toUpperCase()==="FILLER",redefines:void 0,pic:void 0,occurs:void 0,children:[]},C=r.match(Ut);C&&(R.redefines=C[1].replace(/\.$/,""));const u=r.match(Qt);if(u){const E=Yt(u[2]);E&&(R.pic=E)}const d=r.match(wt);d&&(R.occurs={times:parseInt(d[1],10)});let I;if(u){const E=r.slice(u.index+u[0].length);let f=E.match(/\bUSAGE\s+(?:IS\s+)?([A-Z0-9\-]+)\b/i);f?I=f[1]:(f=E.match(/\b(COMP-1|COMP-2|COMP-3|COMP-5|COMP|COMPUTATIONAL-3|COMPUTATIONAL|BINARY|DISPLAY)\b/i),f&&(I=f[1]))}else{let E=r.match(/\bUSAGE\s+(?:IS\s+)?([A-Z0-9\-]+)\b/i);E||(E=r.match(/\b(COMP-1|COMP-2|COMP-3|COMP-5|COMP|COMPUTATIONAL-3|COMPUTATIONAL|BINARY|DISPLAY)\b/i)),E&&(I=E[1])}for(I&&(R.usage=zt(I));s.length&&s[s.length-1].level>=i;)s.pop();s.length===0?n.push(R):s[s.length-1].children.push(R),s.push(R)}return(function r(o){for(const i of o)i.isFiller&&(i.name=`FILLER-${a++}`),r(i.children)})(n),n}function Ue(t){const e=(t.usage||"DISPLAY").toUpperCase(),n=t.pic;if(!n)return 0;if(e==="DISPLAY")return n.length;if(e==="COMP-1")return 4;if(e==="COMP-2")return 8;if(e==="COMP"||e==="BINARY"||e==="COMP-5"){const s=n.type==="NUMERIC"?n.length:0;return s<=4?2:s<=9?4:8}if(e==="COMP-3"){const s=n.type==="NUMERIC"?n.length:0;return Math.ceil((s+1)/2)}return n.length}function qt(t){const e=new Map;(function C(u){for(const d of u)e.set(d.name,d),C(d.children)})(t);const n={};(function C(u){for(const d of u){if(d.redefines){const I=d.redefines;n[I]||=new Set([I]),n[I].add(d.name)}C(d.children)}})(t);const s={};for(const[C,u]of Object.entries(n))s[C]=Array.from(u);const a={};for(const[C,u]of Object.entries(s))for(const d of u)a[d]=C;const r=C=>{if(C.children.length&&!C.pic&&!C.redefines){let I=0;for(const f of C.children)I+=r(f);const E=C.occurs?.times??1;return I*E}const u=C.pic?Ue(C):0,d=C.occurs?.times??1;return u*d},o={},i=[];let l=0;const c=[],R=(C,u)=>{let d=u;for(const I of C){let E=d;if(I.redefines){const h=I.redefines;h in o?E=o[h]:console.warn(`REDEFINES base not found yet: ${h}. Ensure base appears before redefiner.`)}I.name in o||(o[I.name]=E);const f=a[I.name];let v=!1;f&&(c.push({group:f,member:I.name}),v=!0);const A=r(I);if(I.children.length&&!I.pic){const h=I.occurs?.times??1,p=h?A/h:A;for(let D=0;D<h;D++)R(I.children,E+D*p)}else{const h=I.occurs?.times??1,p=I.pic?Ue(I):0;for(let D=0;D<h;D++)i.push({...I,offset:E+D*p,byteLength:p,variantPath:c.length?c.slice():void 0})}v&&c.pop(),I.redefines?l=Math.max(l,E+A):(d+=A,l=Math.max(l,d))}};return R(t,0),{root:t,fieldsFlat:i,recordLength:l,redefineGroups:s,nameIndex:Object.fromEntries(e)}}const ze={"CNAB240-PIX":`      *----------------------------CNAB240-----------------------------*
      *----------------------------HDR-ARQ-----------------------------*
